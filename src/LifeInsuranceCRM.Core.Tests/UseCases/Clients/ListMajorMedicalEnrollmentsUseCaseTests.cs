...
public class ListMajorMedicalEnrollmentsUseCaseTests : UseCaseTestBase<ListMajorMedicalEnrollmentsUseCase>
{
    private readonly Guid _tenantId;
    private readonly Guid _userId;
    private readonly Guid _clientId;
    private readonly CancellationToken _ct = CancellationToken.None;
    private readonly ListMajorMedicalEnrollmentsRequest _request;
    ...
    public ListMajorMedicalEnrollmentsUseCaseTests()
    {
        _tenantId = CreateGuid();
        _userId = CreateGuid();
        _clientId = CreateGuid();
        _request = new ListMajorMedicalEnrollmentsRequest { ClientId = _clientId };
    }

    protected override ListMajorMedicalEnrollmentsUseCase BuildSubject() =>
        new(
            ActorTracker.Object,
    ...
    public sealed class Success_Setup : ListMajorMedicalEnrollmentsUseCaseTests, IAsyncLifetime
    {
        public Success_Setup()
        {
            ...
            var enrollments = new[] { TestFixture.CreateMajorMedicalEnrollment(enrollmentId, _clientId, _tenantId, _userId, now) };
        ...
        public async Task InitializeAsync()
        {
            ...
            {
                Result = await subject.Execute(ProcessRequest<ListMajorMedicalEnrollmentsRequest>.From(_request, _ct));
            });
        }
    ...
    public sealed class Success : IClassFixture<Success_Setup>
    {
        ...
        {
            var response = (ProcessResponse<IReadOnlyList<MajorMedicalEnrollmentDto>>)_fixture.Result!;
    ...
    public sealed class ClientNotFound_Setup : ListMajorMedicalEnrollmentsUseCaseTests, IAsyncLifetime
    {
