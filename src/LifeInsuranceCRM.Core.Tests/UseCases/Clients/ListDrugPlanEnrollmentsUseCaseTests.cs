...
public class ListDrugPlanEnrollmentsUseCaseTests : UseCaseTestBase<ListDrugPlanEnrollmentsUseCase>
{
    private readonly Guid _tenantId;
    private readonly Guid _userId;
    private readonly Guid _clientId;
    private readonly CancellationToken _ct = CancellationToken.None;
    private readonly ListDrugPlanEnrollmentsRequest _request;
    ...
    public ListDrugPlanEnrollmentsUseCaseTests()
    {
        _tenantId = CreateGuid();
        _userId = CreateGuid();
        _clientId = CreateGuid();
        _request = new ListDrugPlanEnrollmentsRequest { ClientId = _clientId };
    }

    protected override ListDrugPlanEnrollmentsUseCase BuildSubject() =>
        new(
            ActorTracker.Object,
    ...
    public sealed class Success_Setup : ListDrugPlanEnrollmentsUseCaseTests, IAsyncLifetime
    {
        public Success_Setup()
        {
            ...
            var enrollments = new[] { TestFixture.CreateDrugPlanEnrollment(enrollmentId, _clientId, _tenantId, _userId, now) };
        ...
        public async Task InitializeAsync()
        {
            ...
            {
                Result = await subject.Execute(ProcessRequest<ListDrugPlanEnrollmentsRequest>.From(_request, _ct));
            });
        }
    ...
    public sealed class Success : IClassFixture<Success_Setup>
    {
        ...
        {
            var response = (ProcessResponse<IReadOnlyList<DrugPlanEnrollmentDto>>)_fixture.Result!;
    ...
    public sealed class ClientNotFound_Setup : ListDrugPlanEnrollmentsUseCaseTests, IAsyncLifetime
    {
