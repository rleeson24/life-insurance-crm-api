...
public class GetClientUseCaseTests : UseCaseTestBase<GetClientUseCase>
{
    private readonly Guid _tenantId;
    private readonly Guid _userId;
    private readonly Guid _clientId;
    private readonly CancellationToken _ct = CancellationToken.None;
    private readonly GetClientRequest _request;
    ...
    public GetClientUseCaseTests()
    {
        ...
        _request = new GetClientRequest { ClientId = _clientId };
    }
    ...
    public sealed class NotFound_Setup : GetClientUseCaseTests, IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            {
                Result = await subject.Execute(ProcessRequest<GetClientRequest>.From(_request, _ct));
            });
        }
    ...
    public sealed class Success_Setup : GetClientUseCaseTests, IAsyncLifetime
    {
