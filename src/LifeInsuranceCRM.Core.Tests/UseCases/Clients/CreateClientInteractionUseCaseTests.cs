...
public class CreateClientInteractionUseCaseTests : UseCaseTestBase<CreateClientInteractionUseCase>
{
    ...
    private readonly CreateClientInteractionModel _inputModel;
    private readonly ClientInteraction _createdInteraction;
    ...
    public CreateClientInteractionUseCaseTests()
    {
    ...
    protected override CreateClientInteractionUseCase BuildSubject() =>
        new(
            ActorTracker.Object,
            NowProvider.Object,
    ...
    public sealed class Success_Setup : CreateClientInteractionUseCaseTests, IAsyncLifetime
    {
        public Success_Setup()
        {
            ...
            ClientInteractionRepository
                ...
                .ReturnsAsync(_createdInteraction);
        }
        ...
        public async Task InitializeAsync()
        {
            ...
            {
                Result = await subject.Execute(ProcessRequest<CreateClientInteractionModel>.From(_inputModel, _ct));
            });
        }
    ...
    public sealed class Success : IClassFixture<Success_Setup>
    {
        ...
        [Fact]
        public void Result_InteractionId_MatchesRepository()
        {
            var response = (ProcessResponse<ClientInteractionDto>)_fixture.Result!;
            Assert.Equal(_fixture._createdInteraction.ClientInteractionId, response.Result!.ClientInteractionId);
        }
    }

    public sealed class ClientNotFound_Setup : CreateClientInteractionUseCaseTests, IAsyncLifetime
    {
