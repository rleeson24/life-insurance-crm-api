# Applies live/*.sql in the same order as Aspire LiveSchemaScripts (001–009).
...
#
#   .\apply-live-schema.ps1 -ConnectionString "Server=localhost,1433;Database=LifeInsuranceCRM;..." -IncludeSeed
param(
