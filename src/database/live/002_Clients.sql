...
BEGIN
    ...
    (
        ...
        DateOfBirth                   varbinary(max)   NULL,
        MedicareNumber                varbinary(max)   NULL,
        MedicareNumberBlindIndex      varbinary(32)    NULL,
        MedicarePartAEffectiveDate    varbinary(max)   NULL,
        MedicarePartBEffectiveDate    varbinary(max)   NULL,
